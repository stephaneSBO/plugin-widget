...
Installation du plugin Widget {#_installation_du_plugin_widget}
=============================
...
Appliquer le widget sur une commande {#_appliquer_le_widget_sur_une_commande}
------------------------------------
...
### Divers exemples pour une même commande {#_divers_exemples_pour_une_même_commande}
...
### Ajouter une option personnalisée {#_ajouter_une_option_personnalisée}
...
Création / Modification de widget {#_création_modification_de_widget}
---------------------------------
...
#### Modification d’un widget {#_modification_d_un_widget}
